...
const ScrollIndicator = () => {
  return (
    <div className="absolute bottom-[30px] left-1/2 -translate-x-1/2 flex flex-col items-center gap-4 opacity-0 hero-scroll-indicator z-50">
      <div className="w-[22px] h-[36px] rounded-full border-[1px] border-[#B08D57]/50 flex justify-center p-1 relative">
        <div className="w-[3px] h-[3px] rounded-full bg-[#D1AE72] absolute top-[8px] animate-[scrollDownDot_2s_ease-in-out_infinite]" />
      </div>
